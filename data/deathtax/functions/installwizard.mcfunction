...
data merge storage versionstrings:deathtax {branch: "Alpha", version: 1.3.1}
...
scoreboard objectives add deathtax.settings.itemTime dummy
scoreboard objectives add deathtax.settings.itemDebuff dummy
...
scoreboard players set #deathtax.setting deathtax.settings.itemTime 0
scoreboard players set #deathtax.setting deathtax.settings.itemDebuff 0
...
scoreboard players set #deathtax.const deathtax.settings.timeStacking 2
