...
data merge storage versionstrings:deathstax {branch: "Alpha", version: 1.3.6}
...
tellraw @a[tag=!global.ignore] [{"text": "Death's Tax","color": "#333333","bold": true},{"text": " by ","color": "white","bold": false},{"text": "TophatMan__","color": "#00ff00","bold": true,"clickEvent": {"action": "open_url","value": "https://www.twitch.tv/tophatman_"}},{"text": " has been installed or updated.","color": "white","bold": false}]
