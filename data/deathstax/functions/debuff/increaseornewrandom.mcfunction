...
execute if score #deathstax.random deathstax.settings.timeAdd matches 1 store result score #deathstax.random deathstax.settings.timeAdd run return run function deathstax:debuff/newrandom
